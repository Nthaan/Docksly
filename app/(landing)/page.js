...
//               <button
//                 className="bg-[#5A7D74] hover:bg-[#4b6e65] text-white px-9 py-2 rounded-lg flex items-center gap-2"
//               >
//                 <img
//                   src="/images/full.png"
//                   alt="Google logo"
//                   className="w-7 h-4"
//                 />
//                 Continue with bladie
//               </button>
//             </div>

//             <div className="flex justify-center mb">
//               <button
//                 className="bg-[#5A7D74] hover:bg-[#4b6e65] text-white px-8 py-2 rounded-lg flex items-center gap-2"
...
//             <p className="text-sm text-[#2F4858] mt-6 text-center">
//               Don't have an account?{" "}
//               <span className="text-[#0D7B84] underline cursor-pointer">
//                 Sign up
//               </span>
//             </p>
//           </div>
